	        ...
	        <h2>Import Demo Data</h2>
	       	...
	       	<div class="radium-importer-wrap" data-demo-id="1"  data-nonce="<?php echo wp_create_nonce('radium-demo-code'); ?>">
    			...
    			<div style="background-color: #F5FAFD; margin:10px 0;padding: 5px 10px;color: #0C518F;border: 2px solid #CAE0F3; clear:both; width:90%; line-height:18px;">
    			    <p class="tie_message_hint">Tips</p>

    			      <ul style="padding-left: 20px;list-style-position: inside;list-style-type: square;}">
  						 <li>The importer will not delete any pages, posts, or content.  It will only add content and adjust theme options.</li>
    						 <li>If the import times out or does not finish, please run the importer again. </li>		
  						 <li>Running the importer mulitple times may duplicate your menu items. If you run the importer again, make sure to delete any navigation menus under Navigation > Menus.  You will not have delete any pages as those will not duplicate.</li>				 
    			      </ul>
    			 </div>
